...
$(document).ready(function(){
	...
	buttonAddCountry =  $("#butonAddCountry");
	buttonUpdateCountry  =  $("#butonUpdateCountry");
	buttonDeleteCountry = $("#butonDeleteCountry");
	...
	$.ajax({
		...
		$("#dropDownCountries option[value='" + optionValue + "']").remove();
		 ...
		 showToastMessage("The country has been deleted");
		  ...
		  showToastMessage("ERRROR: Could not connect to server or sever encounterd an error ");
