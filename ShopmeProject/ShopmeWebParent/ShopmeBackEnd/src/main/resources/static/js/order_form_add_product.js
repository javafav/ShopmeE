...
$("document").ready(function(){
	...
	$("#products").on("click" , "#linkAddProduct" , function(e){
		...
		$("#addProdcutModal").on("shown.bs.modal" , function(){
			$(this).find("iframe ").attr("src" ,url);
			
			
		});
		
		$("#addProdcutModal").modal();
...
getShipppingCost(productId);



}
function getShipppingCost(productId){
			...
			<div class="row">
				<div class="col-1">
					<div class="divCount">${nextCount}</div>
					 <div> <a class="fa fa-trash fa-lg icon-dark  linkRemove"  href="" rowNumber="${nextCount}" ></a></div>
